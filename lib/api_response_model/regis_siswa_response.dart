...
//
//     final regisSiswaResponse = regisSiswaResponseFromJson(jsonString);

import 'dart:convert';

RegisSiswaResponse regisSiswaResponseFromJson(String str) => RegisSiswaResponse.fromJson(json.decode(str));

String regisSiswaResponseToJson(RegisSiswaResponse data) => json.encode(data.toJson());

class RegisSiswaResponse {
  String app;
  String version;
  String release;
  DateTime datetime;
  ...
  factory RegisSiswaResponse.fromJson(Map<String, dynamic> json) => RegisSiswaResponse(
    app: json["app"],
