...
//
//     final otpSiswaResponse = otpSiswaResponseFromJson(jsonString);

import 'dart:convert';

OtpSiswaResponse otpSiswaResponseFromJson(String str) => OtpSiswaResponse.fromJson(json.decode(str));

String otpSiswaResponseToJson(OtpSiswaResponse data) => json.encode(data.toJson());

class OtpSiswaResponse {
  String app;
  String version;
  String release;
  DateTime datetime;
